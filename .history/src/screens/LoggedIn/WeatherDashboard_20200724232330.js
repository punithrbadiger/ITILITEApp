    ...
    return (
      <View>
          ...
          <ScrollView
            ...
            <View style={styles.pressureVisiblBlockView}>
              <View style={styles.pressureBox}>
                <Image
                  source={pressure}
                  style={styles.pressureImage}
                />
                <Text
                  style={styles.pressureText}>
                  Pressure
                </Text>
                <Image source={line} style={styles.indexLine} />
                <Text
        ...
        <View
          ...
          <TouchableOpacity style={styles.bottomButtonStyle} onPress={this.open_PlayStore}>
            <Text style={styles.bottomButtonTextStyle}>Navigate to playstore</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.bottomButtonStyle} onPress={this.signoutUser}>
