...
class WeatherDashboard extends React.Component {
  ...
  render() {
    ...
    console.log(
      'new Date(ReportData.dt_txt).getTime()',
      new Date(ReportData.dt_txt).getTime(),
    );
    console.log('new Date().getTime()', new Date().getTime());

    var msDiff = new Date(ReportData.dt_txt).getTime() - new Date().getTime(); //Future date - current date
    var daysTill30June2035 = Math.floor(msDiff / (1000 * 60 * 60 * 24));
    console.log('wdwwd', daysTill30June2035);
