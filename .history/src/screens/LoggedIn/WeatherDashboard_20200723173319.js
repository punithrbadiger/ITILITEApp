...
class WeatherDashboard extends React.Component {
  ...
  getWeather() {
    ...
    let url =
      ...
      `http://api.openweathermap.org/data/2.5/weather?lat=${this.state.currentLatitude}&lon=${this.state.currentLongitude}&APPID=${3e8628659484d984269e1ff36d017820}&units=metric`
