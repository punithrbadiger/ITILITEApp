...
class addPost extends React.Component {
  ...
  render() {
    return (
     <View style={{ flexDirection: row, backgroundColor: '#fff', margin: 32}}>
<View style={{ flex: 1, marginRight: 24 }}>
  <View style={{ height: '33%', marginBottom: 24, borderWidth: 1, borderRadius: 24}}> 
...
<View style={{ flex: 1}}>
  <View style={{ height: '60%', marginBottom: 24, borderWidth: 1, borderRadius: 24}}>
