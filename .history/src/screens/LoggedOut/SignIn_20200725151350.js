...
const rightArrow = require('../../Assets/Icons/rightIcon.png');
      ...
      .then((res) => {
        TouchID.authenticate()
          .then((success) => {
            ...
            console.log(
              'this.props.userList.users.length',
              this.props.userList.deviceAuthorized,
            );
            if (this.props.userList.deviceAuthorized != false) {
